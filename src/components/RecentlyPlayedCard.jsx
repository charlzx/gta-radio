...
const RecentlyPlayedCard = ({ recentlyPlayed, onStationSelect }) => {
  ...
  return (
    <div className={`bg-white/10 backdrop-blur-xl rounded-xl border border-white/5 mb-6 ${isMobile ? 'p-2' : 'p-4'}`}>
          ...
          >
            <div className="relative">
              <img 
                src={station.logo} 
                alt={station.name} 
                className={`rounded object-cover ${isMobile ? 'w-6 h-6' : 'w-10 h-10'}`} 
              />
